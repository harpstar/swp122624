    ...
    <>
      ...
      <main className="pathway-page__levels-container">
        ...
        <div className="pathway-page__level-container">
          ...
          {/* 1 */}
          <h4 style={{cursor: 'pointer'}} onClick={() => setIsBuildingMaintenanceWorkerOpen(prev => !prev)}>Wastewater
            Operator I</h4>

          <Collapse isOpen={isBuildingMaintenanceWorkerOpen}>
            <p>Operates and maintains wastewater treatment, sludge processing, and handling equipment. Tends pumps,
              conveyors, blowers, chlorinators, vacuum filters, and other equipment used to treat wastewater. Collects
              samples and makes routine chemical analyses of wastewater at various points in the plant process.</p>
            ...
            <ul>
              ...
              <li>Completion of two water or sewage treatment education courses at the community college level is
                required
              </li>
            ...
            <ul>
              <li>One year of experience in the operation of wastewater treatment plant, incorporating biological pond
                treatment, preliminary and primary treatment, Biological Nutrient Removal (BNR) activated sludge
                treatment, tertiary treatment and biosolids handling facilities is preferred
              </li>
            </ul>

            <h4>Licenses:</h4>
            <ul>
              <li>Ability to obtain a valid Wastewater (WW) Operator-in-Training (OIT) Certification within 30 days of
                employment and ability to obtain Grade I Wastewater Treatment Plant Operator Certificate within 18
        ...
        <div className="pathway-page__level-container">
          ...
          <Collapse isOpen={isBuildingOperatorOpen}>
            ...
            <ul>
              ...
              <li>Completion of fifteen college level units relating to water/sewage treatment or environmental studies,
                and/or Water/Sewage Associates Degree
              </li>
            </ul>

            <h4>Work Experience:</h4>
            <ul>
              <li>Two years of experience in the operation of a sewage treatment plant, incorporating biological pond
                treatment, preliminary and primary treatment, Biological Nutrient Removal (BNR) activated sludge
                treatment, tertiary treatment, and biosolids handling facilities is required.
              </li>
              <li>Ability to read and interpret standard operating procedures (SOPs), operational manuals and required
                facility permits is required.
              </li>
            </ul>

            <h4>Licenses:</h4>
            <ul>
              <li>Valid Grade II WW Treatment Plant Operator Certificate issued by the State Water Resources Control
                Board is required
              </li>
            </ul>
        ...
        <div className="pathway-page__level-container">
          ...
          <Collapse isOpen={isFacilitiesManagerOpen}>
            <p>Operates and maintains wastewater treatment, sludge processing, and handling equipment. Tends pumps,
              conveyors, blowers, chlorinators, vacuum filters, and other equipment used to treat wastewater.</p>
            ...
            <h4>Education:</h4>
            <ul>
              <li>High School Diploma or Equivalent Completion of thirty college level units relating to water/sewage
                treatment or environmental studies is preferred.
              </li>
            ...
            <h4>Work Experience:</h4>
            <ul>
              <li>Three years of experience in the operation of a Grade V wastewater recycling facility, incorporating
                biological pond treatment, preliminary and primary treatment, Biological Nutrient Removal (BNR)
                activated sludge treatment, tertiary treatment, membrane treatment, and biosolids handling facilities,
                or an equivalent combination of education and experience required
              </li>
              <li>Ability to read and interpret standard operating procedures (SOP), blueprints, schematics,
                operational/maintenance manuals, required facility permits, and follows written and verbal instructions
              </li>
            </ul>

            <h4>Licenses:</h4>
            <ul>
              <li>Valid Grade III WW Treatment Plant Operator Certificate issued by the State Water Resources Control
                Board is required
              </li>
            </ul>
